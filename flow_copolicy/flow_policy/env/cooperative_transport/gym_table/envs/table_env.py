...
from flow_policy.env.cooperative_transport.gym_table.envs.custom_rewards import custom_reward_function
from flow_policy.env.cooperative_transport.gym_table.envs.game_objects.game_objects import (
    Agent,
    Obstacle,
    Table,
    Target,
...
class TableEnv(gym.Env):
    ...
    def init_data_paths(self, map_config, run_mode, run_name):
        ...
        if not exists(self.dirname_vis_ep):
            ...
            os.makedirs(self.dirname_vis_ep, exist_ok=True)
