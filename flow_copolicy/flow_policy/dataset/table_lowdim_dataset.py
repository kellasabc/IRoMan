...
from flow_policy.common.sampler import SequenceSampler, get_val_mask
from flow_policy.model.common.normalizer import LinearNormalizer, SingleFieldLinearNormalizer
from flow_policy.dataset.base_dataset import BaseLowdimDataset
...
class TableLowdimDataset(BaseLowdimDataset):
    ...
    def _sample_to_data(self, sample):
        obs = sample[self.obs_key] # T, D_o - 观察数据完全从数据集中读取，不进行修改
        if self.past_action_key is not None:
            data = {
                'obs': obs,
