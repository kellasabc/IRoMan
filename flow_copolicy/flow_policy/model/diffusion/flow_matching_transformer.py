...
from flow_policy.model.diffusion.positional_embedding import SinusoidalPosEmb
from flow_policy.model.common.module_attr_mixin import ModuleAttrMixin

logger = logging.getLogger(__name__)

class FlowMatchingTransformer(ModuleAttrMixin):
    def __init__(self,
            input_dim: int,
            output_dim: int,
            horizon: int,
    ...
    def _init_weights(self, module):
        ...
        elif isinstance(module, FlowMatchingTransformer):
    ...
    def forward(self, 
        ...
        """
        x: (B,T,input_dim)
        timestep: (B,) or float, flow matching time
        cond: (B,T',cond_dim)
