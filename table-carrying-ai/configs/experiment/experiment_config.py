...
def get_experiment_args(parser):
    ...
    parser.add_argument(
        "--data-dir",
        type=str,
        default="datasets/rnd_obstacle_v2/diffusion-training",
        help="Name of of dataset directory storing past trajectory rollouts; full path from base directory",
    )
    parser.add_argument(
        "--map-dir",
        type=str,
        default="datasets/rnd_obstacle_v2/diffusion-training/map_cfg", #"datasets/table-demos/table-demos_map-cfg/map_cfg",
