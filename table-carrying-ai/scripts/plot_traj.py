...
def main():
    ...
    parser.add_argument(
        "--path-to-traj",
        type=str,
        default="/home/ubuntu/IRoMan/table-carrying-ai/results/test_p1-planner_p2-human-keyboard/test_p1-planner_p2-human-keyboard-ep_239.npz",
        help="Path to trajectory file (.npz)",
    )
    parser.add_argument(
        "--path-to-gt",
        type=str,
        default="/home/ubuntu/IRoMan/table-carrying-ai/datasets/rnd_obstacle_v2/diffusion-training/ep_239/ep_239.npz",
        help="Path to trajectory file (.npz)",
    )
    parser.add_argument(
        "--path-to-map",
        type=str,
        default="/home/ubuntu/IRoMan/table-carrying-ai/datasets/rnd_obstacle_v2/diffusion-training/map_cfg/ep_239.npz",
