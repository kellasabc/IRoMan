...
def main(exp_args, exp_name):
    ...
    # Check if data_dir contains subdirectories or direct files
    ...
    #     if isfile(join(exp_args.map_dir, sd)) and (sd.endswith('.yml') or sd.endswith('.npz'))
    # ]
