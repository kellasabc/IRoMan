#!/usr/bin/env python3
"""
Diffusion Transformer Training Script - Collaborative Lifting Task (using human action as condition)
...
@hydra.main(
    ...
    config_name="train_diffusion_transformer_lowdim_lifting_human_cond"
)
def main(cfg):
    # Set device
    ...
    # Start training
    print("Starting Diffusion Transformer training - Collaborative Lifting Task (using human action as condition)...")
    ...
    print(f"Condition dimension: {cfg.policy.model.cond_dim}")
    ...
    print("5. Human Action Condition: Using past_action as additional condition")
    print("==========================================\n")
