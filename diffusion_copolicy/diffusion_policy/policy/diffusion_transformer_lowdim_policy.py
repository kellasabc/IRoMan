    ...
    def predict_action(self, obs_dict: Dict[str, torch.Tensor]) -> Dict[str, torch.Tensor]:
        ...
        if self.obs_as_cond:
            ...
            if self.human_act_as_cond:
                ...
                cond_human = nobs['past_action'][:, :To, self.robot_action_dim:] # human previous actions as conditioning
        ...
        # run sampling
        # Filter out parameters that shouldn't be passed to scheduler
        scheduler_kwargs = {k: v for k, v in self.kwargs.items() 
                           if k not in ['robot_action_dim', 'human_action_dim']}
