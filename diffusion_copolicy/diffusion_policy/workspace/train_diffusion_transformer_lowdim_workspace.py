...
class TrainDiffusionTransformerLowdimWorkspace(BaseWorkspace):
    ...
    def run(self):
        ...
        if cfg.training.debug:
            ...
            # Only set if rollout_every exists
            if hasattr(cfg.training, 'rollout_every'):
        ...
        with JsonLogger(log_path) as json_logger:
            for local_epoch_idx in range(cfg.training.num_epochs):
                ...
                if hasattr(cfg.training, 'rollout_every') and (self.epoch % cfg.training.rollout_every) == 0:
